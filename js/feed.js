...
let cuerpoAncianos = [wilmer, cesar, melquiades, jose]
let cardsAnciano
cuerpoAncianos.forEach((anciano) => {
	...
	<div class="card shadow">
		<ul class="nav">
			<li>
				<a class="btn btn-secondary mt-2" onclick="copiarAlPortapapeles('${anciano.ID}')" id="boton${anciano.nombre}">Copiar</a>
			</li>
		</ul>
